...
$query = "SELECT  showname,startdate,enddate,location,Company,image FROM showname WHERE Company = '$var_value'";
        ...
        <body>
           ...
           <ul class ="nav">
            ...
            <div class ="Shows">
                ...
                <h1 class = one><?php echo  $StartDate."--".$enddate ?></h1>
           ...
           <img src ="Hamlet (Small).jpg" style ="float:left; width:70%; height:65%;margin-right:0%;margin-left:15%;border:3px solid black;">
           <button class="button button1" onclick="location='SeatSelector.html'">Show Times</button>
