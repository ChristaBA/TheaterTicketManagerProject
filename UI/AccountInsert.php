...
if($get_rows >= 1)
{
    ...
    header("refresh:3; url = Administrator.html");
}
else{
$sql = "INSERT INTO worker (firstname, lastname, password, login,  companyName)
VALUES ('$first_name', '$last_name','$password_login', '$login_sql',  '$company_Name')";
