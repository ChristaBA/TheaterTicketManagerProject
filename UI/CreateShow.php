          ...
          <div class ="Banner">
			...
			<label class ="label">Start Date:</label><input type="text" name="StartDate"><br>
                        ...
                        <label class ="label">Location:</label><input type="text" name="Location"><br>
                         <label class ="label">Poster URL:</label><input type="text" name="PosterUrl"><br>
                         <label class ="label">Company:</label><input type="text" name="Company"><br>
                     <!-- <label class ="fileContainer">Upload Poster: </label><input type="file" name="Poster"><br>-->
