...
$query = "SELECT  showname,startdate,enddate,location,Poster FROM showname";
  ...
  background-color:white;
        ...
        <body>
           ...
           <ul class ="nav">
            ...
            <div class ="Shows">
                <h1 class = one><?php echo $showname?> </h1>
                <h1 class = one><?php echo $location?> </h1>
                 <h1 class = one><?php echo $StartDate?> </h1>
          <!-- <img src =".$row['Poster']" style ="float:left; width:80%; height:70%;margin-right:0%;margin-left:10%;border:3px solid black;">-->
           <img src =".$url" style ="float:left; width:80%; height:70%;margin-right:0%;margin-left:10%;border:3px solid black;">
