...
$sql = "INSERT INTO seasonticket (firstname, lastname,  ticketnumber, email, phonenumber, seat, day, time, address)
VALUES ('$first_name', '$last_name','$ticket_Number', '$email_sql', $phone_Number, '$seat_sql', '$day_sql', '$time_sql', '$address_sql')";
